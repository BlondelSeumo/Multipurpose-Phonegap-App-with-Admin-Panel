    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (
          ...
          carousel_class += ' carousel-withcontent '
        }
          ...
          $.each(data['attachment'], function (i, v) {
            if (
              ...
              if (
                ...
                html += '<div class="spacer-large"></div>'
              }
              html += '<h4>' + v.title + '</h4>'
              if (data.display_content == 'showcontent') {
                html += '<h6 class="light white-text">' + v.brief + '</h6>'
              }
              html += '</div>'
              html += '</div>'
            } else {
