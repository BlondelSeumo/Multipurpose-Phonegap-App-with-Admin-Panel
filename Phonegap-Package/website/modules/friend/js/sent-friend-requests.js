$(document).ready(function () {
  ...
  form_data.append('type', 'sent-requests')
    ...
    success: function (response) {
      ...
      $.each(data['items'], function (i, v) {
        ...
        html +=
          ...
          '"  data-action="' +
          frid +
          '" class="btn btn-small modal-trigger modal-trigger-sentfrreq">' +
          frbtn +
          '</a> '
        html +=
  ...
  $(document).on('click', '.modal-trigger-sentfrreq', function (e) {
    ...
    //console_log("modal-trigger-sentfrreq"+id);
  })

  $(document).on('click', '#delete-sentfrreq', function (e) {
    var id = $('.modal-disp').attr('id')
    var userid = $('.modal-disp').attr('data-userid')
    var action = 'delete_friend_request'
